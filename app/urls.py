...
urlpatterns = [
    ...
    path('dashboard/enseignant/cours/<int:cours_id>/fiche-cotes/', views.fiche_de_cotes_cours, name='fiche_de_cotes_cours'),
    path('dashboard/enseignant/cours/<int:cours_id>/creer-evaluation/', views.creer_evaluation_enseignant, name='creer_evaluation_enseignant'),
    ...
    path('dashboard/enseignant/propositions/', views.propositions_enseignant, name='propositions_enseignant'),
    ...
    path('enseignant/accepter-proposition/<int:proposition_id>/', views.accepter_proposition, name='accepter_proposition'),
